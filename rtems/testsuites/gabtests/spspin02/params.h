...
-T 1,0.017,0 -T 1,0.000,0 -T 2,0.017,0 -T 2,0.015,0 -T 3,0.010,0 -T 3,0.011,0 -T 3,0.019,0 -T 3,0.006,0 -T 4,0.020,0 -T 5,0.013,0 -T 7,0.008,0 -T 7,0.009,0 -T 8,0.008,0 -T 9,0.004,0 -T 9,0.007,0 -T 9,0.017,0 -T 12,0.015,0 -T 14,0.010,0 -T 15,0.004,0 -T 17,0.001,0 -T 17,0.000,0 -T 18,0.010,0 -T 19,0.005,0 -T 19,0.011,0 -T 20,0.002,0 -T 21,0.004,0 -T 21,0.016,0 -T 22,0.019,0 -T 23,0.005,0 -T 24,0.001,0 -T 25,0.009,0 -T 25,0.009,0 -T 26,0.006,0 -T 26,0.014,0 -T 26,0.021,0 -T 26,0.017,0 -T 26,0.000,0 -T 27,0.011,0 -T 27,0.016,0 -T 28,0.018,0 -T 29,0.016,0 -T 30,0.012,0 -T 30,0.002,0 -T 30,0.006,0 -T 31,0.018,0 -T 31,0.009,0 -T 31,0.014,0 -T 31,0.009,0 -T 32,0.018,0 -T 34,0.017,0 -T 34,0.013,0 -T 35,0.004,0 -T 35,0.010,0 -T 35,0.011,0 -T 36,0.014,0 -T 36,0.007,0 -T 36,0.006,0 -T 37,0.011,0 -T 37,0.013,0 -T 38,0.010,0 -T 39,0.009,0 -T 40,0.020,0 -T 40,0.014,0 -T 40,0.001,0 -T 42,0.014,0 -T 42,0.003,0 -T 42,0.008,0 -T 43,0.009,0 -T 43,0.014,0 -T 43,0.006,0 -T 44,0.018,0 -T 45,0.007,0 -T 45,0.011,0 -T 46,0.006,0 -T 46,0.019,0 -T 46,0.003,0 -T 47,0.002,0 -T 47,0.006,0 -T 48,0.004,0 -T 49,0.004,0 
*/
...
rtems_task_priority Priorities[1+NUM_TASKS]= { 0, 1, 1, 2, 2, 3, 3, 3, 3, 4, 5, 7, 7, 8, 9, 9, 9, 12, 14, 15, 17, 17, 18, 19, 19, 20, 21, 21, 22, 23, 24, 25, 25, 26, 26, 26, 26, 26, 27, 27, 28, 29, 30, 30, 30, 31, 31, 31, 31, 32, 34, 34, 35, 35, 35, 36, 36, 36, 37, 37, 38, 39, 40, 40, 40, 42, 42, 42, 43, 43, 43, 44, 45, 45, 46, 46, 46, 47, 47, 48, 49 };

uint32_t  Periods[1+NUM_PERIODIC_TASKS]    = { 0, 1, 1, 2, 2, 3, 3, 3, 3, 4, 5, 7, 7, 8, 9, 9, 9, 12, 14, 15, 17, 17, 18, 19, 19, 20, 21, 21, 22, 23, 24, 25, 25, 26, 26, 26, 26, 26, 27, 27, 28, 29, 30, 30, 30, 31, 31, 31, 31, 32, 34, 34, 35, 35, 35, 36, 36, 36, 37, 37, 38, 39, 40, 40, 40, 42, 42, 42, 43, 43, 43, 44, 45, 45, 46, 46, 46, 47, 47, 48, 49 };

uint32_t  Execution_us[1+NUM_TASKS]        = {
                                             0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             1*0.017*CONFIGURE_MICROSECONDS_PER_TICK,
                                             1*0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             2*0.017*CONFIGURE_MICROSECONDS_PER_TICK,
                                             2*0.015*CONFIGURE_MICROSECONDS_PER_TICK,
                                             3*0.01*CONFIGURE_MICROSECONDS_PER_TICK,
                                             3*0.011*CONFIGURE_MICROSECONDS_PER_TICK,
                                             3*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             3*0.006*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.02*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             17*0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             21*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             22*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             23*0.005*CONFIGURE_MICROSECONDS_PER_TICK,
                                             24*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             25*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             25*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             26*0.006*CONFIGURE_MICROSECONDS_PER_TICK,
                                             26*0.014*CONFIGURE_MICROSECONDS_PER_TICK,
                                             26*0.021*CONFIGURE_MICROSECONDS_PER_TICK,
                                             26*0.017*CONFIGURE_MICROSECONDS_PER_TICK,
                                             26*0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             27*0.011*CONFIGURE_MICROSECONDS_PER_TICK,
                                             27*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             28*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             29*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             31*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             31*0.014*CONFIGURE_MICROSECONDS_PER_TICK,
                                             31*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             32*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             34*0.017*CONFIGURE_MICROSECONDS_PER_TICK,
