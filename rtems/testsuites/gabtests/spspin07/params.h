...
-T 1,0.009,0 -T 2,0.001,0 -T 2,0.009,0 -T 2,0.017,0 -T 3,0.007,0 -T 4,0.018,0 -T 4,0.005,0 -T 5,0.004,0 -T 5,0.009,0 -T 6,0.003,0 -T 6,0.008,0 -T 7,0.015,0 -T 7,0.008,0 -T 8,0.013,0 -T 9,0.016,0 -T 9,0.001,0 -T 10,0.002,0 -T 10,0.009,0 -T 12,0.001,0 -T 12,0.015,0 -T 13,0.000,0 -T 14,0.011,0 -T 15,0.007,0 -T 17,0.001,0 -T 17,0.005,0 -T 17,0.003,0 -T 17,0.016,0 -T 21,0.013,0 -T 21,0.014,0 -T 22,0.009,0 -T 22,0.001,0 -T 23,0.015,0 -T 24,0.018,0 -T 24,0.002,0 -T 24,0.018,0 -T 25,0.002,0 -T 26,0.011,0 -T 26,0.015,0 -T 27,0.001,0 -T 27,0.012,0 -T 27,0.015,0 -T 28,0.015,0 -T 29,0.004,0 -T 29,0.018,0 -T 30,0.004,0 -T 30,0.016,0 -T 31,0.016,0 -T 32,0.002,0 -T 33,0.002,0 -T 33,0.015,0 -T 34,0.016,0 -T 35,0.001,0 -T 35,0.011,0 -T 36,0.018,0 -T 36,0.017,0 -T 36,0.017,0 -T 36,0.009,0 -T 36,0.013,0 -T 37,0.019,0 -T 37,0.001,0 -T 38,0.009,0 -T 39,0.016,0 -T 39,0.004,0 -T 39,0.016,0 -T 40,0.008,0 -T 40,0.003,0 -T 41,0.014,0 -T 41,0.014,0 -T 42,0.018,0 -T 44,0.013,0 -T 45,0.013,0 -T 45,0.011,0 -T 45,0.005,0 -T 45,0.004,0 -T 46,0.016,0 -T 47,0.018,0 -T 48,0.001,0 -T 48,0.010,0 -T 49,0.018,0 -T 50,0.018,0 
*/
...
rtems_task_priority Priorities[1+NUM_TASKS]= { 0, 1, 2, 2, 2, 3, 4, 4, 5, 5, 6, 6, 7, 7, 8, 9, 9, 10, 10, 12, 12, 13, 14, 15, 17, 17, 17, 17, 21, 21, 22, 22, 23, 24, 24, 24, 25, 26, 26, 27, 27, 27, 28, 29, 29, 30, 30, 31, 32, 33, 33, 34, 35, 35, 36, 36, 36, 36, 36, 37, 37, 38, 39, 39, 39, 40, 40, 41, 41, 42, 44, 45, 45, 45, 45, 46, 47, 48, 48, 49, 50 };

uint32_t  Periods[1+NUM_PERIODIC_TASKS]    = { 0, 1, 2, 2, 2, 3, 4, 4, 5, 5, 6, 6, 7, 7, 8, 9, 9, 10, 10, 12, 12, 13, 14, 15, 17, 17, 17, 17, 21, 21, 22, 22, 23, 24, 24, 24, 25, 26, 26, 27, 27, 27, 28, 29, 29, 30, 30, 31, 32, 33, 33, 34, 35, 35, 36, 36, 36, 36, 36, 37, 37, 38, 39, 39, 39, 40, 40, 41, 41, 42, 44, 45, 45, 45, 45, 46, 47, 48, 48, 49, 50 };
...
uint32_t  Execution_us[1+NUM_TASKS]        = {
                                             ...
                                             4*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             7*0.015*CONFIGURE_MICROSECONDS_PER_TICK,
                                             7*0.008*CONFIGURE_MICROSECONDS_PER_TICK,
                                             8*0.013*CONFIGURE_MICROSECONDS_PER_TICK,
                                             9*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             23*0.015*CONFIGURE_MICROSECONDS_PER_TICK,
                                             24*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             27*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             29*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             30*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             30*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             31*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             36*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             38*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             39*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             39*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             39*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             40*0.008*CONFIGURE_MICROSECONDS_PER_TICK,
                                             40*0.003*CONFIGURE_MICROSECONDS_PER_TICK,
                                             41*0.014*CONFIGURE_MICROSECONDS_PER_TICK,
                                             41*0.014*CONFIGURE_MICROSECONDS_PER_TICK,
                                             42*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             47*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             48*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             48*0.01*CONFIGURE_MICROSECONDS_PER_TICK,
                                             49*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             50*0.018*CONFIGURE_MICROSECONDS_PER_TICK
                                             };
