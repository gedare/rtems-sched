...
rtems_task_priority Priorities[1+NUM_TASKS]= { 0, 3, 4, 4, 4, 4, 5, 6, 6, 7, 8, 8, 9, 10, 10, 10, 11, 11, 11, 11, 12, 13, 13, 15, 15, 15, 16, 18, 18, 19, 19, 19, 19, 20, 21, 21, 22, 22, 23, 23, 24, 25, 26, 27, 27, 28, 29, 29, 31, 31, 31, 33, 34, 35, 37, 38, 38, 39, 40, 40, 41, 41, 42, 42, 43, 43, 43, 44, 45, 46, 46, 47, 47, 48, 48, 48, 48, 49, 49, 49, 50 };

uint32_t  Periods[1+NUM_PERIODIC_TASKS]    = { 0, 3, 4, 4, 4, 4, 5, 6, 6, 7, 8, 8, 9, 10, 10, 10, 11, 11, 11, 11, 12, 13, 13, 15, 15, 15, 16, 18, 18, 19, 19, 19, 19, 20, 21, 21, 22, 22, 23, 23, 24, 25, 26, 27, 27, 28, 29, 29, 31, 31, 31, 33, 34, 35, 37, 38, 38, 39, 40, 40, 41, 41, 42, 42, 43, 43, 43, 44, 45, 46, 46, 47, 47, 48, 48, 48, 48, 49, 49, 49, 50 };

uint32_t  Execution_us[1+NUM_TASKS]        = {
                                             0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             3*0.017*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.007*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             5*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             6*0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             6*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             11*0.007*CONFIGURE_MICROSECONDS_PER_TICK,
                                             11*0.015*CONFIGURE_MICROSECONDS_PER_TICK,
                                             11*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             12*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             13*0.008*CONFIGURE_MICROSECONDS_PER_TICK,
                                             13*0.01*CONFIGURE_MICROSECONDS_PER_TICK,
                                             15*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             18*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             20*0.013*CONFIGURE_MICROSECONDS_PER_TICK,
                                             21*0.014*CONFIGURE_MICROSECONDS_PER_TICK,
                                             21*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             22*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             22*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             23*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             23*0.002*CONFIGURE_MICROSECONDS_PER_TICK,
                                             24*0.002*CONFIGURE_MICROSECONDS_PER_TICK,
                                             25*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             26*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             27*0.011*CONFIGURE_MICROSECONDS_PER_TICK,
                                             27*0.017*CONFIGURE_MICROSECONDS_PER_TICK,
                                             28*0.002*CONFIGURE_MICROSECONDS_PER_TICK,
                                             29*0.005*CONFIGURE_MICROSECONDS_PER_TICK,
                                             29*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             31*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             31*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             38*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             41*0.008*CONFIGURE_MICROSECONDS_PER_TICK,
                                             42*0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             42*0.006*CONFIGURE_MICROSECONDS_PER_TICK,
                                             43*0.017*CONFIGURE_MICROSECONDS_PER_TICK,
