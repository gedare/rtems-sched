...
rtems_task_priority Priorities[1+NUM_TASKS]= { 0, 1, 2, 2, 4, 4, 4, 6, 6, 7, 8, 8, 9, 9, 9, 9, 10, 11, 13, 14, 15, 15, 15, 15, 15, 17, 17, 17, 19, 19, 20, 20, 20, 20, 22, 22, 23, 24, 24, 24, 25, 27, 27, 27, 28, 29, 31, 31, 33, 34, 34, 35, 36, 36, 36, 37, 37, 37, 38, 39, 40, 40, 41, 41, 42, 43, 43, 44, 45, 45, 46, 46, 46, 46, 47, 48, 49, 49, 49, 50, 50 };

uint32_t  Periods[1+NUM_PERIODIC_TASKS]    = { 0, 1, 2, 2, 4, 4, 4, 6, 6, 7, 8, 8, 9, 9, 9, 9, 10, 11, 13, 14, 15, 15, 15, 15, 15, 17, 17, 17, 19, 19, 20, 20, 20, 20, 22, 22, 23, 24, 24, 24, 25, 27, 27, 27, 28, 29, 31, 31, 33, 34, 34, 35, 36, 36, 36, 37, 37, 37, 38, 39, 40, 40, 41, 41, 42, 43, 43, 44, 45, 45, 46, 46, 46, 46, 47, 48, 49, 49, 49, 50, 50 };
...
uint32_t  Execution_us[1+NUM_TASKS]        = {
                                             ...
                                             14*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             15*0.005*CONFIGURE_MICROSECONDS_PER_TICK,
                                             15*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             28*0.012*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             35*0.022*CONFIGURE_MICROSECONDS_PER_TICK,
                                             36*0.005*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             46*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
                                             47*0.021*CONFIGURE_MICROSECONDS_PER_TICK,
                                             48*0.015*CONFIGURE_MICROSECONDS_PER_TICK,
                                             49*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             49*0.011*CONFIGURE_MICROSECONDS_PER_TICK,
                                             49*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             50*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             50*0.019*CONFIGURE_MICROSECONDS_PER_TICK
                                             };
