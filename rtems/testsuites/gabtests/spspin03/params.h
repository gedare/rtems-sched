...
-T 2,0.001,0 -T 3,0.005,0 -T 3,0.002,0 -T 4,0.012,0 -T 6,0.018,0 -T 6,0.010,0 -T 10,0.011,0 -T 12,0.021,0 -T 21,0.014,0 -T 24,0.013,0 -T 24,0.011,0 -T 29,0.012,0 -T 30,0.014,0 -T 33,0.007,0 -T 34,0.005,0 -T 41,0.018,0 -T 43,0.014,0 -T 44,0.002,0 -T 44,0.008,0 -T 50,0.002,0 
*/
...
rtems_task_priority Priorities[1+NUM_TASKS]= { 0, 2, 3, 3, 4, 6, 6, 10, 12, 21, 24, 24, 29, 30, 33, 34, 41, 43, 44, 44, 50 };

uint32_t  Periods[1+NUM_PERIODIC_TASKS]    = { 0, 2, 3, 3, 4, 6, 6, 10, 12, 21, 24, 24, 29, 30, 33, 34, 41, 43, 44, 44, 50 };
...
uint32_t  Execution_us[1+NUM_TASKS]        = {
                                             ...
                                             41*0.018*CONFIGURE_MICROSECONDS_PER_TICK,
