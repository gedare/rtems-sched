...
{
#if DISPLAY_OTHER
  printf("%c",(char) (tiles[0] + '0'));
  printf("%c",(char) (tiles[1] + '0'));
  printf("%c\n",(char) (tiles[2] + '0'));

  printf("%c",(char) (tiles[3] + '0'));
  printf("%c",(char) (tiles[4] + '0'));
  printf("%c\n",(char) (tiles[5] + '0'));

  printf("%c",(char) (tiles[6] + '0'));
  printf("%c",(char) (tiles[7] + '0'));
  printf("%c\n",(char) (tiles[8] + '0'));
#endif
/*
	cout << 
...
rtems_task Task_8puzzle( rtems_task_argument argument )
{
#if DISPLAY_OTHER
	printf("STL A* 8-puzzle solver implementation\n(C)2001 Justin Heyes-Jones\n");
#endif
/*
	if( argc > 1 )
	{
...
//		cout << "SearchSteps : " << astarsearch.GetStepCount() << endl;
  ...
  /* TODO: check for number of completed tasks */
  MAGIC_BREAKPOINT;
  rtems_test_exit( 0 );
}
