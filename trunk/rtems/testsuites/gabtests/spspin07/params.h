...
-T 1,0.042,0 -T 2,0.011,0 -T 2,0.019,0 -T 4,0.009,0 -T 4,0.039,0 -T 7,0.042,0 -T 9,0.004,0 -T 12,0.023,0 -T 15,0.009,0 -T 16,0.022,0 -T 18,0.029,0 -T 19,0.034,0 -T 20,0.006,0 -T 22,0.004,0 -T 24,0.001,0 -T 26,0.001,0 -T 28,0.008,0 -T 31,0.025,0 -T 32,0.026,0 -T 33,0.017,0 -T 33,0.005,0 -T 35,0.013,0 -T 35,0.075,0 -T 36,0.020,0 -T 36,0.014,0 -T 37,0.015,0 -T 37,0.006,0 -T 38,0.028,0 -T 39,0.030,0 -T 39,0.033,0 -T 40,0.021,0 -T 40,0.035,0 -T 41,0.002,0 -T 42,0.041,0 -T 42,0.038,0 -T 42,0.005,0 -T 42,0.005,0 -T 44,0.001,0 -T 47,0.038,0 -T 48,0.002,0 
*/
...
rtems_task_priority Priorities[1+NUM_TASKS]= { 0, 1, 2, 2, 4, 4, 7, 9, 12, 15, 16, 18, 19, 20, 22, 24, 26, 28, 31, 32, 33, 33, 35, 35, 36, 36, 37, 37, 38, 39, 39, 40, 40, 41, 42, 42, 42, 42, 44, 47, 48 };

uint32_t  Periods[1+NUM_PERIODIC_TASKS]    = { 0, 1, 2, 2, 4, 4, 7, 9, 12, 15, 16, 18, 19, 20, 22, 24, 26, 28, 31, 32, 33, 33, 35, 35, 36, 36, 37, 37, 38, 39, 39, 40, 40, 41, 42, 42, 42, 42, 44, 47, 48 };

uint32_t  Execution_us[1+NUM_TASKS]        = {
                                             0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             1*0.042*CONFIGURE_MICROSECONDS_PER_TICK,
                                             2*0.011*CONFIGURE_MICROSECONDS_PER_TICK,
                                             2*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.039*CONFIGURE_MICROSECONDS_PER_TICK,
                                             7*0.042*CONFIGURE_MICROSECONDS_PER_TICK,
                                             9*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             12*0.023*CONFIGURE_MICROSECONDS_PER_TICK,
                                             15*0.009*CONFIGURE_MICROSECONDS_PER_TICK,
                                             16*0.022*CONFIGURE_MICROSECONDS_PER_TICK,
                                             18*0.029*CONFIGURE_MICROSECONDS_PER_TICK,
                                             19*0.034*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             31*0.025*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             35*0.075*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             38*0.028*CONFIGURE_MICROSECONDS_PER_TICK,
                                             39*0.03*CONFIGURE_MICROSECONDS_PER_TICK,
                                             39*0.033*CONFIGURE_MICROSECONDS_PER_TICK,
                                             40*0.021*CONFIGURE_MICROSECONDS_PER_TICK,
                                             40*0.035*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             47*0.038*CONFIGURE_MICROSECONDS_PER_TICK,
