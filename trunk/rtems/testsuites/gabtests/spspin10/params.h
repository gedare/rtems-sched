...
rtems_task_priority Priorities[1+NUM_TASKS]= { 0, 1, 1, 3, 4, 5, 5, 5, 6, 6, 8, 8, 8, 9, 9, 11, 12, 12, 12, 13, 14, 14, 15, 15, 15, 16, 16, 16, 17, 18, 18, 19, 19, 19, 20, 21, 22, 23, 23, 23, 24, 24, 24, 25, 25, 26, 27, 28, 29, 29, 30, 30, 30, 30, 31, 31, 31, 31, 31, 33, 34, 34, 35, 35, 35, 35, 36, 37, 37, 39, 42, 44, 45, 46, 46, 46, 47, 47, 48, 49, 49 };

uint32_t  Periods[1+NUM_PERIODIC_TASKS]    = { 0, 1, 1, 3, 4, 5, 5, 5, 6, 6, 8, 8, 8, 9, 9, 11, 12, 12, 12, 13, 14, 14, 15, 15, 15, 16, 16, 16, 17, 18, 18, 19, 19, 19, 20, 21, 22, 23, 23, 23, 24, 24, 24, 25, 25, 26, 27, 28, 29, 29, 30, 30, 30, 30, 31, 31, 31, 31, 31, 33, 34, 34, 35, 35, 35, 35, 36, 37, 37, 39, 42, 44, 45, 46, 46, 46, 47, 47, 48, 49, 49 };

uint32_t  Execution_us[1+NUM_TASKS]        = {
                                             0*CONFIGURE_MICROSECONDS_PER_TICK,
                                             1*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             1*0.004*CONFIGURE_MICROSECONDS_PER_TICK,
                                             3*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             4*0.014*CONFIGURE_MICROSECONDS_PER_TICK,
                                             5*0.003*CONFIGURE_MICROSECONDS_PER_TICK,
                                             5*0.013*CONFIGURE_MICROSECONDS_PER_TICK,
                                             5*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             6*0.008*CONFIGURE_MICROSECONDS_PER_TICK,
                                             6*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             8*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             14*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             15*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             15*0.019*CONFIGURE_MICROSECONDS_PER_TICK,
                                             15*0.021*CONFIGURE_MICROSECONDS_PER_TICK,
                                             16*0.008*CONFIGURE_MICROSECONDS_PER_TICK,
                                             16*0.001*CONFIGURE_MICROSECONDS_PER_TICK,
                                             16*0.021*CONFIGURE_MICROSECONDS_PER_TICK,
                                             17*0.016*CONFIGURE_MICROSECONDS_PER_TICK,
                                             ...
                                             48*0.005*CONFIGURE_MICROSECONDS_PER_TICK,
                                             49*0.008*CONFIGURE_MICROSECONDS_PER_TICK,
                                             49*0.02*CONFIGURE_MICROSECONDS_PER_TICK
                                             };
